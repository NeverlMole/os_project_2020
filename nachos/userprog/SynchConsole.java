...
public class SynchConsole {
   ...
   */
  public OpenFile openForReading() { return new File(true, false); }
   ...
   */
  public OpenFile openForWriting() { return new File(false, true); }
  ...
  private class File extends OpenFile {
    ...
    public void close() { canRead = canWrite = false; }
