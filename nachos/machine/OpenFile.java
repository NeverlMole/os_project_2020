...
public class OpenFile {
   ...
   */
  public int read(int pos, byte[] buf, int offset, int length) { return -1; }
   ...
   *		failure.
   */
  public int write(int pos, byte[] buf, int offset, int length) { return -1; }
   ...
   * @return	the actual number of bytes successfully read, or -1 on failure.
   */
  public int read(byte[] buf, int offset, int length) { return -1; }
   ...
   *		failure.
   */
  public int write(byte[] buf, int offset, int length) { return -1; }
