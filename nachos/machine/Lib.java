...
class AssertionFailureError extends Error {
  AssertionFailureError() { super(); }

  AssertionFailureError(String message) { super(message); }
}
...
public final class Lib {
   ...
   */
  public static void assertNotReached() { assertTrue(false); }
   ...
   */
  public static String toHexString(int i) { return toHexString(i, 8); }
