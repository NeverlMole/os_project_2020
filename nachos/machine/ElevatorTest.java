...
public final class ElevatorTest {
  ...
  private class ElevatorController implements ElevatorControllerInterface {
    ...
    private void interrupt() { eventWait.V(); }
  ...
  private class Rider implements RiderInterface {
    ...
    public void run() {
      ...
      e = getNextEvent();
      Lib.assertTrue(e.event == RiderEvent.eventDoorsOpened && e.floor == 0 &&
                     e.elevator == 0);
      ...
      e = getNextEvent();
      Lib.assertTrue(e.event == RiderEvent.eventDoorsClosed && e.floor == 0 &&
                     e.elevator == 0);

      e = getNextEvent();
      Lib.assertTrue(e.event == RiderEvent.eventDoorsOpened && e.floor == 1 &&
                     e.elevator == 0);
