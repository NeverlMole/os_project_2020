...
public final class Processor {
   ...
   */
  public Runnable getExceptionHandler() { return exceptionHandler; }
   ...
   */
  public boolean hasTLB() { return usingTLB; }
   ...
   */
  public int getNumPhysPages() { return numPhysPages; }
   ...
   */
  public byte[] getMemory() { return mainMemory; }
  ...
  private void finishLoad() { delayedLoad(0, 0, 0); }
   ...
   */
  public void advancePC() { advancePC(registers[regNextPC] + 4); }
  ...
  public static final String exceptionNames[] = {
      "syscall      ", "page fault   ", "TLB miss     ", "read-only    ",
  ...
  private class ProcessorPrivilege implements Privilege.ProcessorPrivilege {
    public void flushPipe() { finishLoad(); }
  }
  ...
  private class Instruction {
    ...
    private boolean test(int flag) { return Lib.test(flag, flags); }
    ...
    private void print() {
      ...
      if (operation == Mips.INVALID) {
        System.out.print(
            "invalid: op=" + Lib.toHexString(op, 2) + " rs=" +
            Lib.toHexString(rs, 2) + " rt=" + Lib.toHexString(rt, 2) + " rd=" +
            Lib.toHexString(rd, 2) + " sh=" + Lib.toHexString(sh, 2) +
      ...
      for (int i = 0; i < args.length; i++) {
        ...
        case Mips.RT:
          ...
          if (Lib.test(dbgFullDisassemble) && (i != 0 || !test(Mips.DST)) &&
  ...
  private static class Mips {
    ...
    static final int INVALID = 0, UNIMPL = 1, ADD = 2, SUB = 3, MULT = 4,
                     DIV = 5, SLL = 6, SRA = 7, SRL = 8, SLT = 9, AND = 10,
                     OR = 11, NOR = 12, XOR = 13, LUI = 14, MFLO = 21,
                     MFHI = 22, MTLO = 23, MTHI = 24, JUMP = 25, BEQ = 26,
                     BNE = 27, BLEZ = 28, BGTZ = 29, BLTZ = 30, BGEZ = 31,
                     SYSCALL = 32, LOAD = 33, LWL = 36, LWR = 37, STORE = 38,
                     SWL = 39, SWR = 40, MAX = 40;
    ...
    static final int DST = 0x00000001, DSTRA = 0x00000002,
                     ...
                     SRC2IMM = 0x00000010, UNSIGNED = 0x00000020,
                     LINK = 0x00000040, DELAYEDLOAD = 0x00000080,
                     SIZEB = 0x00000100, SIZEH = 0x00000200, SIZEW = 0x00000400,
                     BRANCH = 0x00000800;
    ...
    static final char RS = 's', RT = 't', RD = 'd', IMM = 'i',
        ...
        TARGET = 'j',
                      RETURNADDRESS =
                          'r'; // rd, or none if rd=31; can't be last
