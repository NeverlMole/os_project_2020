...
public final class Interrupt {
   ...
   */
  public void enable() { setStatus(true); }
   ...
   */
  public boolean disable() { return setStatus(false); }
   ...
   */
  public void restore(boolean status) { setStatus(status); }
  ...
  private void print() {
    System.out.println("Time: " + privilege.stats.totalTicks + ", interrupts " +
                       (enabled ? "on" : "off"));
