...
public abstract class Scheduler {
   ...
   */
  public int getPriority() { return getPriority(KThread.currentThread()); }
   ...
   *		priority.
   */
  public boolean increasePriority() { return false; }
   ...
   *		thread's priority.
   */
  public boolean decreasePriority() { return false; }
}
