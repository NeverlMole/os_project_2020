...
public class AutoGrader {
  ...
  long getTime() { return privilege.stats.totalTicks; }

  void targetLevel(int targetLevel) { this.targetLevel = targetLevel; }
   ...
   *		the default.
   */
  public Coff createLoader(OpenFile file) { return null; }
